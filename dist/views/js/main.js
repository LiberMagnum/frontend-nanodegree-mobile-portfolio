...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 263;
  //determines the number of pizzas by multiplying the possible number of pizza rows by the number of columns
  var pizzaNumber = (screen.height/s)*cols;
  var elem;
  var pizzas = document.querySelector("#movingPizzas1");
